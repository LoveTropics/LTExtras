...
public class LTExtrasNetwork {
    ...
    public static void registerPackets(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(ClientboundEnvironmentAttributesPacket.TYPE, ClientboundEnvironmentAttributesPacket.STREAM_CODEC, ClientboundEnvironmentAttributesPacket::handle);

...
public class ShruggyArmsType extends UnitType {

    public static final ShruggyArmsType INSTANCE = new ShruggyArmsType();
    ...
    public ModelModifierType<UnitType> type() {
        return ExtraModelModifierTypes.SHRUGGY_ARMS.get();
    }

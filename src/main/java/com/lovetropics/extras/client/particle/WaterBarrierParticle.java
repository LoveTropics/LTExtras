...
//    ));
//
//    WaterBarrierParticle(ClientLevel world, double x, double y, double z, Identifier sprite) {
//        super(world, x, y, z);
...
//            return new WaterBarrierParticle(world, x, y, z, Identifier.withDefaultNamespace("item/barrier"));
//        }
//    }
//}

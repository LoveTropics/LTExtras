...
public class ForkliftModel<T extends Entity> extends EntityModel<ForkliftRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition forks = root.addOrReplaceChild("forks", CubeListBuilder.create().texOffs(0, 29).addBox(-3.0F, 5.0F, -8.5F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition back_right = root.addOrReplaceChild("back_right", CubeListBuilder.create().texOffs(72, 0).addBox(-0.79F, -2.45F, -0.9555F, 2.0F, 5.0F, 2.0711F, new CubeDeformation(0.0F))
        ...
        PartDefinition back_left = root.addOrReplaceChild("back_left", CubeListBuilder.create().texOffs(72, 26).addBox(-1.21F, -2.45F, -1.0855F, 2.0F, 5.0F, 2.0711F, new CubeDeformation(0.0F))
        ...
        PartDefinition front_right = root.addOrReplaceChild("front_right", CubeListBuilder.create().texOffs(72, 57).addBox(-0.79F, -2.54F, -0.9605F, 2.0F, 5.0F, 2.0711F, new CubeDeformation(0.0F))
        ...
        PartDefinition front_left = root.addOrReplaceChild("front_left", CubeListBuilder.create().texOffs(66, 72).addBox(-1.21F, -2.45F, -1.0855F, 2.0F, 5.0F, 2.0711F, new CubeDeformation(0.0F))
        ...
        PartDefinition group = root.addOrReplaceChild("group", CubeListBuilder.create().texOffs(0, 55).addBox(-6.55F, -3.65F, 4.8F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(24, 45).addBox(-9.55F, -17.65F, -6.2F, 2.0F, 20.0F, 1.5F, new CubeDeformation(0.0F))
                .texOffs(52, 37).addBox(-7.55F, -8.65F, -5.2F, 7.0F, 2.0F, 0.5F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r1 = group.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(74, 72).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(58, 74).addBox(8.0F, -3.0F, 0.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-8.55F, -1.4957F, 3.0242F, 0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r4 = group.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(74, 7).addBox(-4.5F, -5.0F, -0.15F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.05F, -5.25F, 5.95F, 0.7854F, 0.0F, 0.0F));

        PartDefinition cube_r5 = group.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(78, 45).addBox(-0.75F, -4.5F, -0.75F, 1.5F, 6.5F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(12, 78).addBox(4.75F, -4.5F, -0.75F, 1.5F, 6.5F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.8F, -5.25F, -1.75F, 0.7854F, 0.0F, 0.0F));

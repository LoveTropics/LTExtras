...
public class ExtraCommandArguments {
    ...
    private static final Holder<ArgumentTypeInfo<?, ?>> MODEL_MODIFIER = REGISTER.register("model_modifier", () -> ArgumentTypeInfos.registerByClass(ModelModifierArgumentType.class, SingletonArgumentInfo.contextFree(ModelModifierArgumentType::modelModifier)));
